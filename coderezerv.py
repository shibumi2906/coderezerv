...
def main_loop():
    ...
    messages = [
        ...
        Story_messages('images/s002.png', 'images/p001.png', -400, 200,
                       "Добрый день! Я заметил, \n"
                       "вы продаете самые свежие морепродукты в городе. \n"
        ...
        Story_messages('images/s002.png', 'images/p001.png', -300, 200,
                       "Ах, маяк! Да, есть одна старая легенда о призрачном свете, который видят моряки. \n "
                       "Говорят, это душа старого сторожа, \n"
                       "который до сих пор не может покинуть свою пост. \n"
                       "Но это, конечно, просто байки."),
        Story_messages('images/s002.png', 'images/p001.png', -300, 200,
                       "Интересно... А как насчет людей, \n"
                       "которые сейчас работают в маяке или знают о нем что-то еще?"),
        Story_messages('images/s002.png', 'images/p001.png', -300, 200,
                       "На самом деле, лучше всего спросить у Лиз, она часто бывает в маяке. \n "
                       "Или у Марка, владельца кафе. Они могут рассказать вам больше."),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       "Встреча с местным художником, Карлом Алекс замечает Карла,\n"
                       " рисующего пейзаж маяка на холсте недалеко от рынка."),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       " Здравствуйте! Ваша картина выглядит потрясающе. Вы часто рисуете маяк?"),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       "  Привет! Да, маяк всегда вдохновлял меня. Его история, атмосфера...\n"
                       " этот символ надежды и покровительства для всех мореплавателей."),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       " Я пишу статью о маяке. Не поделитесь, что вас вдохновляет или какие вы слышали истории?"),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       " О, многое. Прежде всего, его неизменность и таинственность. \n"
                       "По ночам, когда маяк светится, кажется, будто он живой. \n"
                       "Но у меня сложилось впечатление, что там происходят странные вещи. \n"
                       "К примеру, недавно один из сторожей, Том, пропал, так и не найден..."),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100, " Пропал? Это должно быть большой историей"),
        Story_messages('images/s003.png', 'images/p001.png', -500, 100,
                       " а, это весьма загадочно. \n"
                       "Многие старожилы перешептываются, но точно ничего не знают.\n"
                       " Может быть, Марк или Лиз смогут рассказать вам подробнее."),
        ...
        Story_messages('images/s004.png', 'images/p001.png', -500, 100,
                       "Посещение кафе Морской Бриз Взяв \n"
                       "на заметку информацию, полученную от Эммы и Карла, \n"
                       "Алекс направляется в кафе Морской Бриз для встречи с Марком, чтобы узнать больше о маяке и его тайнах.\n"
                       "Алекс заходит в уютное кафе Морской Бриз, расположенное недалеко от порта."),
        Story_messages('images/s004.png', 'images/p004.png', 600, 400,
                       "Внутри царит приятная атмосфера: стены украшены морскими узлами и старинными картами.\n"
                       " Алекса встретил владелец, мужчина лет пятидесяти, по имени Марк."),
        Story_messages('images/s004.png', 'images/p004.png', -500, 100,
                       "Здравствуйте! Я слышал, что ваше кафе \n"
                       "— лучшее место в городе для кофе. \n"
                       "Можно мне чашку капучино?"),
        Story_messages('images/s004.png', 'images/p004.png', 600, 400,
        ...
        Story_messages('images/s010-1.png', 'images/p001.png', -500, 400,
                       "По мере того как земля продолжала дрожать под его ногами, Алекс смело шагал вперед, словно притянутый невидимой силой к тайнам, скрывающимся в глубинах маяка. Мистический свет, исходящий из стен коридора, освещал его путь, создавая неповторимую атмосферу загадки и опасности."),
        Story_messages('images/s010-1.png', 'images/p001.png', -500, 400,
                       "Внезапно перед ним возникла небольшая пещера, ее стены усыпанные древними рунами и символами, светящимися тусклым светом. В середине пещеры, на алтаре, лежал древний свиток, завернутый в пыльные пергаменты."),
        Story_messages('images/s010.png', 'images/p001.png', -500, 400,
                       "Алекс, испытывая странное чувство волнения и тревоги, подходит к алтарю и осторожно поднимает свиток. Он раскрывает его и начинает читать старинные записи, которые могут содержать ключ к тайнам маяка "),
        Story_messages('images/s010.png', 'images/p001.png', -500, 400,
                       " .С каждым словом, которое он прочитывает, мистическая энергия вокруг него становится все сильнее. Он узнает о древнем обряде, проводимом сторожами маяка для защиты его от злых духов моря."),
        Story_messages('images/s010.png', 'images/p001.png', -500, 400,
                       "Свиток описывает каждую деталь церемонии, начиная от призыва сил природы и заканчивая заклинаниями, защищающими маяк от зла.  "),
        Story_messages('images/s010.png', 'images/p001.png', -500, 400,
                       " Завершив чтение, Алекс понимает, что обнаружил нечто невероятное - забытую магию, способную изменить судьбу маяка и его обитателей. "),
